...
Haptic feedback is a way of transferring information to the user via the sense of touch, usually through \texcolor{green}{the same input} device the user gives commands with.
