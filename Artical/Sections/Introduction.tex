...
Section IV \textcolor{green}{contains descriptions of the modification made in order to improve the refresh rate of the communication between devices.}\textcolor{purple}{contains descriptions of various problems pertaining the requirement of transparency and explanations of methods used to address them.}
