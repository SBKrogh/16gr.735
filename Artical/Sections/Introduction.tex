...
Interest in robotic surgery has increased over the last couple of years,
...
The problem with the operator having exclusively visual feedback lies in the fact that the surgeon has to estimate the force applied by observing the color changes of the skin and organs for each maneuver.

% The problem with the operator having exclusively visual feedback lies in the fact that the surgeon has to estimate the force applied by observing the \textcolor{green}{color changes}\textcolor{red}{ in the video feed caused by the deformation} \todo{it changes color} of the skin and organs for each maneuver.
 %\textcolor{green}{
