...
The purpose of haptic or force feedback is to apply force that resist the operators movement in such a way that it reperesents some information about the environment or situation.
...
\node[box] (ros) at ($(3,0) + (Geo)$) {ROS};
\node[box] (davin) at ($(3,0) + (ros)$) {Da Vinci\\robot};
