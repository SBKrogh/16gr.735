...
\begin{tikzpicture}
    ...
    \draw [<->] (Geomagic) -- node[label=above:TCP/IP] {} (ROS);
    \draw [<->] (ROS) -- node [label=above:UDP] {} (DaVinci);
\end{tikzpicture}
...
In order to have some sort of measure of force 
