...
\subsection{Communication}
 ...
 It was stated before that the requirements for our system was to get to at least 600Hz and to reach 1000Hz if possible. As shown in Table \ref{tab:UDPMeasurements}, the connexion can go up to almost 1000Hz using UDP. However, the jitter is high and should not be neglected as in real time operation it may cause unexpected behaviour of the system. Addictional safety precautions should be taken to prevent those behaviour.
