...
\title{Teleoperation of a surgical robot using force feedback}
...
% affiliations
\author{
	\IEEEauthorblockN{Dániel Bolgár, Simon Krogh, Filip Marić, Nicolas Silvani}
	\IEEEauthorblockA{Aalborg University
	\\Department of Electronic Systems
		\\\{dbolga16, skrogh13, fmaric16, nsilva16\}@student.aau.dk}
}
...
%\IEEEauthorblockA{\IEEEauthorrefmarkf{3}Starfleet Academy, San Francisco, California 96678-2391\\
...
% creates the second title. It wiXll be ignored for other modes.
...
\input{Sections/Force_estimation}
