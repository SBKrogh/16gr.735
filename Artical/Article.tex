...
The main challenge we face in making a model lies in the fact that the pulley system on the Endowrist is non-linear, and thus it's full dynamics cannot be modeled in a simple manner.
...
We do this by applying a known force $F$ to the gripper.
