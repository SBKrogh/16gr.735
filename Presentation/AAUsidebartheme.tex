...
\title[Teleoperation of a surgical robot using force feedback]% optional, use only with long paper titles
...
{
	Group 735 \\
  \scalebox{0.6}{Dániel Bolgár}\\ \vspace{-1mm}
  \scalebox{0.6}{Filip Marić}\\ \vspace{-1mm}
