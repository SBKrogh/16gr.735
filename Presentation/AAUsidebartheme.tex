...
\title[Automatic container model craneTeleoperation of a surgical robot using force feedback]% optional, use only with long paper titles
...
\author[Gruppe 735] % optional, use only with lots of authors
{
	Gruppe 633 \\
  \scalebox{0.6}{Dániel Bolgá}\\ \vspace{-1mm}
...
%\input{Sections/Vinkel.tex}
%%%%%%%%%%%%%%%%
%\input{Sections/Daniel.tex}
%%%%%%%%%%%%%%%%
%\input{Sections/Thomas.tex}
%%%%%%%%%%%%%%%%
%\input{Sections/Ralf.tex}
%%%%%%%%%%%%%%%%

\input{Sections/Simon.tex}
