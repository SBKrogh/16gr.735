...
\frametitle{Communication}
  ...
  \begin{itemize}
  \item Requirement for force feedback: 1000 Hz

  \item Maximum for the initial system: 100 Hz
  \item Our approach:
      \begin{itemize}
        \item Reducing the size of exchanged data
        \item Changing the transport protocol
      \end{itemize}
