...
\node [dataset, right of=mpro, node distance=7cm] (ROS) {\textbf{ROS computer}
\begin{itemize}[itemsep=0pt,partopsep=0pt,topsep=0pt] 
\item 1
\item 2
\item 3 
...
\draw[->, ultra thick] ([yshift=-1cm]mpro.east) -- ([yshift=-1cm]ROS.west)node[right of=mpro, node distance=3.9cm] {UDP}; % ([yshift=-1cm]ROS.west) should probaly be edited!!!
\draw[<-, ultra thick] ([yshift=1cm]mpro.east) -- ([yshift=1cm]ROS.west);



\node [dataset, right of=ROS, node distance=5.5cm] (GT) {\textbf{Geomagic Touch}
	\begin{itemize}[itemsep=0pt,partopsep=0pt,topsep=0pt] 
	\item 1
	\item 2
	\item 3 
...
\draw[->, ultra thick] ([yshift=-1cm]ROS.east) -- ([yshift=-1cm]GT.west); % ([yshift=-1cm]ROS.west) should probaly be edited!!!
