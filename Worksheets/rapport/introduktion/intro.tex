...
In this project two aspects of force feedback are covered:
...
%\end{document}
\todo{state that we don't need to reprecent the force applied 100 \% correct but only needs to reprecent the trend of the force. Remember a reference..
If this is not't done, we have to redo some things in the "model structure"}