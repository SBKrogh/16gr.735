...
\node[box] (Handle) at ($(0,-2.5)+(Check_Receive)$) {Convert the bitcod\\and make data available\\to higher levels};
...
\draw[->, ultra thick] (Check_Receive.east) -- ++(0.75,0) |- (Sleep.east);
