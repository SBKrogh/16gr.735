\subsection{Minimizing the size of the transmitted messages}
...
With the original format, the packet contained 346 characters, see \secref{subsec:JSON}. With the new format, the packet that contains the same information is 49 bytes. Therefore, the packets following the new format uses 15\% of the original size.
\begin{figure}[h]
\centering
\begin{tikzpicture}
