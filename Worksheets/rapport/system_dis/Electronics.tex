...
The control of these motors are done through the ESCON motor drivers, which are connected to the sbRIO board.\todo{Somehow we need to include the datasheets within the worksheets}
