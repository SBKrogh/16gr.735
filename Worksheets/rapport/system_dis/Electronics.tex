...
The four motors for actuating the Endowrist is sold as a bulk solution which include motor, gear and a position encoder, see \figref{fig:Full_motor _dis}. For further information on data specific see datasheet\todo{include somehow datasheet}.
