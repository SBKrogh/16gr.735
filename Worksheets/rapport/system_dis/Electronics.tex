...
The control of these motors are done through the ESCON motor drivers, which are connected to the sbRIO board.\todo{What can the motor handle voltage current wattage, what is the gearing and what about the encoder}
...
\end{figure}
\todo{should we include a ref for the pictures?}
