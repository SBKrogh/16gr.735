...
\todo{should we include the computer in the system description or is this to little a subject to cover?}
...
\end{figure}
\todo{maybe we should exclude Embedded system to sbRIO insted?}
