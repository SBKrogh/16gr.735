...
For making the force measurement for the EndoWrist a simple hardware construction was build. This was made due to the lack of the hardware available at Aalborg university. A simple block diagram of setup can be seen on \figref{fig:arduino_loadcell}
...
It can be seen on \figref{fig:arduino_loadcell} that an Arduino is used in the data samples. This was done since a library designed for the Arduino was found.
...
\todo{Measurement protocols should be in appendix.
You should put the figures and an explanation of the test in the main report}
