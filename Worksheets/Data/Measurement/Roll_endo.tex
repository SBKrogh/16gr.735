\subsection{EndoWrist torque measurement}% \label{app:...}
...
It can be seen on figure \figref{fig_roll_mes} that the roll-torque of the EndoWrist has a linear growth from approx 100 mA and up.
