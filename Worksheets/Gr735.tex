...
\include{rapport/Estimation/Models}
 \begin{figure}[H]
\hspace{-2.5em}\includegraphics[width=\linewidth]{modelyaw_a}
\caption{Yaw model excited with different types of inputs.}
\label{fig:final_res_yaw}
\end{figure}
 \begin{figure}[H]
\hspace{-2.5em}\includegraphics[width=\linewidth]{modelpitch2_a}
\caption{Yaw model excited with different types of inputs.}
\end{figure}
