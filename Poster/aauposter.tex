...
\begin{posterbox}[name=discussion,column=2,below=results_and_simulations]{Discussion}

\end{posterbox}

\begin{posterbox}[name=conclusion,column=1,below=results_and_simulations,above=bottom]{Conclusion}

\end{posterbox}

\begin{posterbox}[name=references,column=2,below=discussion,above=bottom]{References}
