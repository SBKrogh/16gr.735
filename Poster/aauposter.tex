...
\begin{posterbox}[name=Control,column=1,span=2]{Control}
...
\begin{posterbox}[name=discussion,column=1,below=results_and_simulations,above=bottom]{Discussion}

\end{posterbox}

\begin{posterbox}[name=conclusion,column=2,below=results_and_simulations]{Conclusion}
\input{conclusion.tex} 
\end{posterbox}

\begin{posterbox}[name=references,column=2,above=bottom,,below=conclusion]{References}
