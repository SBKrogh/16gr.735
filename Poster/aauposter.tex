...
\begin{itemize}
\item The encoding was changed to bitcode resulting in a \textbf{86\%} packet size decrease.
\item In order to increase communication speed it was decided to use UDP instead of TCP as it does not retransmit any packets or implement any features to improve long distance communications. In our system, retransmission of packets would lead to retransmitting obsolete data instead of transmitting new ones. 

\end{itemize}
\bigskip
The new communication system is able to reach a speed of \textbf{637 Hz}. 
